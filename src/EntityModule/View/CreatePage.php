...
class CreatePage implements ViewFileGenerator
{
    /**
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><?= Icon::SHIELD ?>&nbsp;&nbsp;{$entityName} Admin - Add</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/admin">Admin</a></li>
                    <li class="breadcrumb-item"><a href="/admin/{$name}">{$entityName}</a></li>
                    <li class="breadcrumb-item active">Add {$entityName}</li>
                </ol>
            </div>
        </div>
    </div>
